...
import { Link, redirect, useFetcher, useNavigate, type ActionFunctionArgs } from 'react-router';
import { z } from 'zod';
...
export async function action({request}: ActionFunctionArgs) {
    ...
    try {
        const success = await sendForgetPasswordRequest(request, payload.data.email);
